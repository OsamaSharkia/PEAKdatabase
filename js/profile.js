    ...
    if (profileForm) {
      profileForm.addEventListener("submit", async (e) => {
        ...
        try {
          ...
          const { error } = await supabaseClient.from("user_profiles").upsert(updatedProfile)
    ...
    if (notificationForm) {
      notificationForm.addEventListener("submit", async (e) => {
        ...
        try {
          ...
          const { error } = await supabaseClient.from("user_profiles").upsert(updatedPreferences)
